...
function doLogin() {
    ...
    authresponse = doAjax('http://gw151.iu.xsede.org:8080/openmrs/ws/rest/v1/session');
...
<script>
            document.addEventListener('DOMContentLoaded', getPatInfo())
        </script>